    ...
    return (
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b>{data.site.siteMetadata.experienceDivision.myblog} | <Link to={data.site.siteMetadata.blog}></Link>{data.site.siteMetadata.experienceCompany.myblog}</b></h5>
